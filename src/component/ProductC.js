...
<div className="col-3">
        ...
        <div className='wishlist-icon position-absolute' >
          <Link className="text-black"><AiOutlineHeart/></Link>
        </div>
         <div className='action-bar position-absolute'>
            ...
            <div className='product-image'>
                <img src="assests/personal-1.jpg" className="img-fluid" alt="product-image"/>
                <img src="assests/headphone-1.jpg" className="img-fluid"  alt="product-image"/>
